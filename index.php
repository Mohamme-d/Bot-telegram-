...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '7833555651:AAHNS6Zqijtd9u3nBZrZZ-Taiqq7qhiJYVU';
...
$chall = "smm_speed1";
$useradmin = "@ii_Hakim";
$sim =-1002303266898; #القناة الرسمية
$PAY =-1002511987500; #الارقام المكتملة
$ess =-1002637899006; #عمليات شراء الارقام
$eer =-1002646754497; #اشعارات الايميلات وتحويل الروبل
if($chat_id==7678697145){
$sudo=$chat_id;
}elseif($chat_id==7678697145){
$sudo=$chat_id;
}else{
$sudo==7678697145;
}
